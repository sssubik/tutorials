...
public void CurrentDate(){
    ...
    private void initComponents() {
        ...
        TextDiagnosis.setBounds(210, 350, 590, 70);
        ...
        panel.add(TextDName);
        TextDName.setBounds(210, 310, 170, 23);
        panel.add(TextSex);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
             ...
             else if (!valid.isString(TextDiagnosis.getText()))
             {
                    Error.setText("Sorry Diagnosis must Be String");
             }
             else{
